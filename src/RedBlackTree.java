// RedBlackTree class
// ALL CREDITS TO : https://www.java-tips.org/java-se-tips-100019/24-java-lang/1904-red-black-tree-implementation-in-java.html
...
public class RedBlackTree {
	 ...
	 */
	private int compare(Comparable item, RedBlackNode t ) {
		if( t == header )
			return 1;
		else
	...
	public static void main( String [ ] args ) {
		...
		if((Integer) (t.findMin()) != 1 ||
				(Integer) (t.findMax()) != NUMS - 1 )
